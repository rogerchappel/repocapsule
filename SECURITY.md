...
Replace this section with the supported versions for `repocapsule`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `repocapsule` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in repocapsule.
